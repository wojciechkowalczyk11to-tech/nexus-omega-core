...
- Gdy użytkownik pyta o otwarty PR: najpierw doradź porównanie commitów/plików i statusu CI; nie usuwaj PR, jeśli zawiera unikalne zmiany; scalaj (squash and merge) dopiero gdy checks są zielone
"""
